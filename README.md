...
The goal is simple:  
**Explore how AI can be engineered with clarity, reliability, and real‑world constraints in mind.**
...
Each folder represents a building block of AI systems engineering — from orchestration tools to prompt design to infrastructure.
...
### **3. AI Tooling**
Utilities and components that support:
- Prompt engineering  
- Workflow automation  
- API integration  
...
Using diagrams, ADRs, and planning documents to explore:
...
- **Frameworks:** Spring Boot, LangChain, FastAPI  
- **Cloud:** AWS (Lambda, ECS, S3, IAM, CloudWatch)  
- **AI:** OpenAI, HuggingFace, vector databases  
- **Infra:** Docker, Terraform  
- **Security:** IAM, KMS, least-privilege patterns  
