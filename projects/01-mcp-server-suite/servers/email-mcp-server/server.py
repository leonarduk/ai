...
Includes support for creating Todoist tasks via email
"""
import smtplib
import os
...
async def list_tools() -> list[Tool]:
    ...
    return [
        ...
        Tool(
            ...
            description="Create a task in Todoist by sending an email. Requires SMTP credentials and TODOIST_EMAIL environment variable.",
            inputSchema={
                "type": "object",
                "properties": {
                    "title": {
...
async def call_tool(name: str, arguments: dict) -> list[TextContent]:
    ...
    elif name == "create_todoist_task":
        todoist_email = os.getenv("TODOIST_EMAIL")
        
        if not todoist_email:
            raise ValueError("Missing TODOIST_EMAIL environment variable. Get your Todoist email from Settings > Integration > Email")
